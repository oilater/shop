...
@RequestMapping(value = "/thymeleaf") // request URL의 경로 지정
public class ThymeleafExController {

	@GetMapping(value = "/ex01") // 주소의 경로 지정 http://localhost/thymeleaf/ex01 로 들어오면 이 메소드가 실행이 될 것
	public String thymeleafEx01(Model model) {
		model.addAttribute("data", "타임리프 예제입니다."); // setAttribute 와 똑같이 (키, 값)을 넣어줌!

		return "thymeleafEx/thymeleafEx01"; // 페이지 경로 - '폴더경로/파일경로' 로 지정!
